...
/**
* @Description 测试过百万级别的数据快速导入
* @Date 15:31 2021/12/30
* @Param
* @return
**/
public class StarRocksStreamLoad {
    private final static String STARROCKS_HOST = "121.89.206.220";
    private final static String STARROCKS_DB = "sys";
    private final static String STARROCKS_TABLE = "id_mapping";
    private final static String STARROCKS_USER = "root";
    private final static String STARROCKS_PASSWORD = "123456";
    ...
    private void sendData(String content) throws Exception {
        ...
        try (CloseableHttpClient client = httpClientBuilder.build()) {
            ...
            put.setHeader("label", "a"+String.valueOf(new Random().nextLong()));
